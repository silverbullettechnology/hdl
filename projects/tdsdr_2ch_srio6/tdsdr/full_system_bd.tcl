...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.axis_tdata_width {64} CONFIG.dram_base_addr {3f800000} CONFIG.enable_interrupt {true} CONFIG.number_of_channel {2} CONFIG.number_of_page_ch0 {1024} CONFIG.number_of_page_ch1 {1024}  ] $ddr_fifo
